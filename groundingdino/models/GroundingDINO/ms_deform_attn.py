        ...
        **kwargs
        ...
        if torch.cuda.is_available() and value.is_cuda and _C is not None:
            ...
            try:
                ...
                # If the CUDA extension was compiled without support for this GPU's SM,
                # fall back to the pure PyTorch implementation.
                msg = str(e)
                if (
                    ...
                    warnings.warn(
                        ...
                        "falling back to PyTorch implementation. Rebuild groundingdino._C for your GPU to fix.",
                        RuntimeWarning,
                    )
